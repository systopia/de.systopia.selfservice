...
class ContactResolve extends AbstractAction implements CompilerPassInterface {
  ...
  public function process(ContainerBuilder $container) {
    ...
    $typeFactoryDefinition->addMethodCall('addAction', ['SelfServiceResolve', 'Civi\Selfservice\ActionProvider\Action\ContactResolve', E::ts('Resolve Self-Service Hash to Contact'), [
