...
class CRM_Selfservice_Upgrader_Base {
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Selfservice_Upgrader(
   ...
   *
   * ```
   * CRM_Selfservice_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Selfservice_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
